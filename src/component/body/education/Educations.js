...
export default class Educations extends React.Component {
    ...
    state = {
        ...
        },
        {
            ...
            description: 'Aspernatur, mollitia, quos maxime eius suscipit sed beatae ducimus quaerat quibusdam perferendis? lusto, quibusdam asperiores underepellat.'
        },
        {
            time: 2012,
    ...
    render() {
        return this.state.educations.map(education => <Education time = {education.time} 
            title = {education.title} description = {education.description} key = {education.time}/>)
    }
}